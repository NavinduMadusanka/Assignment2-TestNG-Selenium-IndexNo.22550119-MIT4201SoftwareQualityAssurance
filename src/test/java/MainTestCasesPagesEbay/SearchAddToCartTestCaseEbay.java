...
public class SearchAddToCartTestCaseEbay extends MainPageTestCaseEbay {
    ...
    public void searchAndBuySamsungPhone() {
        ...
        try {
            String screenshotPath5 = ScreenShotsCaptureUtilsTestCaseEbay.takeScreenshot(driver, "Price Comparison");
            ...
            String screenshotPath4 = ScreenShotsCaptureUtilsTestCaseEbay.takeScreenshot(driver, "Price Comparison");
